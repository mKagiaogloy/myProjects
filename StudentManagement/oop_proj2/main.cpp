...
private:
    ...
    void panel1()
    {
        ...
        //Anti gia doubleclick ston foithth gia emfanish stoixeiwn/mathimatwn, ginetai kai me button. 92/93/100 seira
...
public:
    ...
    void showlessons(wxCommandEvent& ev)
    {
        ...
        vector <Course> st_courses = this->students.at(pos).get_courses();
        ...
        for (int i = 0, t =st_courses.size(); i < t; i++) {
            student_elements += st_courses.at(i).get_title() + "\n";
        }
        wxMessageBox(wxString(wxString::FromUTF8(student_elements)),wxT("ΕΜΦΑΝΙΣΗ"), wxICON_INFORMATION);
    }
};
